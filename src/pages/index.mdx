...
<center style="color:white">_Why do we care about a theoretically convergent algorithm if the practical version doesn't converge?_</center>
</BlueHighlightedSection>
...
(not even provably convergent) method (NCC-Reg) manages to strongly outperform any of our baselines!
...
When following the theoretical regime (NCC-T), our method  obtains suboptimal performance, but decent!
<Figure>
...
## What's Next?
We are excited to see any further work building off of ours! Some research directions include using bilevel optimisation theoretically 
...
nonstationarity associated with a dynamic buffer. Please don't hestitate to reach out if you have any questions!
